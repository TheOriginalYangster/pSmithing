...
public enum Bar {
    ...
    STEEL(new int[] {440, Data.COAL_ID}, 2353, 3996, 2),
    MITHRIL(new int[] {447, Data.COAL_ID}, 2359, 4158, 3),
    ADAMANT(new int[] {449, Data.COAL_ID}, 2361, 7442, 4),
    RUNE(new int[] {451, Data.COAL_ID}, 2363, 7447, 5);
